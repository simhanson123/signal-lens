...
const REPO_URL = "https://github.com/simhanson123/review-mcp";
...
export function toMarkdown(result: ReviewResult): string {
  ...
  for (const finding of findings) {
    ...
    lines.push(`**Follow-up:** \`/review-mcp false-positive ${finding.id}\` | \`/review-mcp fix ${finding.id}\` | \`/review-mcp explain\``);
    if (finding.repro) {
      lines.push("");
  ...
  lines.push("---");
  lines.push(`*Generated by [review-mcp](${REPO_URL})*`);
